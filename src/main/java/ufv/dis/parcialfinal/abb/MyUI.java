...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        age.setCaption("Type your age here:");

        Button button = new Button("Click Me");
        button.addClickListener(e -> {
            
        	Usuario u = new Usuario(name.getValue(), lastname.getValue(), Integer.parseInt(age.getValue()));
        	Lista.addUsuario(u);
        ...
        layout.addComponents(name, lastname, age, button);
